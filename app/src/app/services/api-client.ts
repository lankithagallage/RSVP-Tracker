...
export class Client {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<EventDtoListPagedResult>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processSearch(
        ...
        _observableMergeMap((_responseText) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = EventDtoListPagedResult.fromJS(resultData200);
          return _observableOf(result200);
        })
      );
    } else if (status === 400) {
    ...
    return _observableOf<EventDtoListPagedResult>(null as any);
  }
